    ...
    return (
      <Slider {...this.props.data}>
        <div>
          <h3>
            <img
              src={require('./../images/writing.png').default}
              alt='writing icon'></img>
          </h3>
        </div>
        <div>
          <h3>
    ...
    <div className='writing-header'>
      <div>
        ...
        <div
          ...
          <img
            src={require('./../images/icon_writing_edit.png').default}
            alt='writing edit'></img>
        </div>
      </div>
      <h2>에어드레서 양도 합니다.</h2>
      <div className='writing-myinfo'>
        <img
          src={require('./../images/icon_profile.png').default}
  ...
  render() {
    return (
      <div className='writing-price'>
        ...
        <p>
          약정 만료일　<span>2022.05.31</span>
        </p>
        <p>
          제품 상태　　<span>사용감 있음</span>
        </p>
        <p>기본정보</p>
        <table>
          <tbody>
  ...
  return (
    <div className={'comment' + data.ml}>
      <div className='comment-id'>
        <img
          src={require('./../images/icon_profile.png').default}
          alt='comment_profile'></img>
        <h4>{data.name}</h4>
        <p>
          <span>{data.time}</span>시간전
        </p>
      </div>
  ...
  return (
    <div className='comment-write'>
      <div
        ...
        {insistBoolean ? (
          <img
            src={require('./../images/icon_insist.png').default}
            alt='icon_insist'></img>
        ) : (
          <img
            src={require('./../images/icon_insist_on.png').default}
            alt='icon_insist'></img>
        )}
      </div>
      ...
      {seller ? (
        ...
        <div
          className='blueToGray'
          onClick={() => {
            pageModal();
          }}>
          <BlueFlat data={'예약중'}></BlueFlat>
        </div>
      ) : (
        <div
          onClick={() => {
