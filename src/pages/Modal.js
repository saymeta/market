  ...
  return nextModal ? (
    complete ? (
      <div className='modal-background'>
        <div className='modal'>
          <img
            src={require('./../images/modal_check.png').default}
            alt='modal'></img>
          <h2>
            <span>매칭 신청</span>이 정상적으로
            <br />
            <span>완료</span>되었습니다.
          </h2>
          ...
          <div>
            <div
              ...
              <BlueFlat data={'매칭현황 보기'}></BlueFlat>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='modal-background'>
        <div className='modal'>
          ...
          <div>
            <div className='gray-flat' onClick={() => closeModal(false)}>
              아니오
            </div>
            <div
              onClick={() => {
