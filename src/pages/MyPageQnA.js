  ...
  return (
    <div
      ...
      <div className='past-qna-header'>
        <h2>
          Q. [계약문의] 문의 드립니다.<span>답변완료</span>
        </h2>
        <img
          src={require('./../images/icon_up.png').default}
          alt='icon_up'></img>
      </div>
                ...
                <div>
                  ...
                  <div className='join-form w-text'>
                    ...
                    <textarea
                      ...
                      name='q-text'
                      placeholder='해당 제품 상태에 관하여 적어주세요.'
                  ...
                  <div className='join-form'>
                    ...
                    <div className='picture'>
                      <div>
                        <img
                          src={require('./../images/list1.png').default}
                          alt='list1_img'></img>
                      </div>
                      <div>
                        <img
                          src={require('./../images/icon_add.png').default}
                          alt='icon_add'
